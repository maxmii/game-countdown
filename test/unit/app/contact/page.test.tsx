...
describe('Contact Page', () => {
    ...
    test('each social link has correct title, link and icon', () => {
        ...
        socialLinks.forEach((link, index) => {
            ...
            expect(screen.getByText(expectedSocialLinks[index].title)).toBeInTheDocument()
            expect(link.querySelector(`.bi-${expectedSocialLinks[index].icon}`)).toBeInTheDocument()
        })
    })
})